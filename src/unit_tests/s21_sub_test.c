...
Suite* suite_sub(void) {
  ...
  tcase_add_test(tc, sub_40);
  tcase_add_test(tc, sub_41);
  tcase_add_test(tc, sub_42);
  tcase_add_test(tc, sub_43);
  tcase_add_test(tc, sub_44);
  tcase_add_test(tc, sub_45);
  tcase_add_test(tc, sub_46);
  tcase_add_test(tc, sub_47);
