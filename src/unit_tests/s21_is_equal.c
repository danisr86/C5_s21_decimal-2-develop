...
Suite *suite_is_equal(void) {
  ...
  tcase_add_test(tc, is_equal_24);
  tcase_add_test(tc, is_equal_25);
  tcase_add_test(tc, is_equal_26);
  tcase_add_test(tc, is_equal_27);
  tcase_add_test(tc, is_equal_28);
  tcase_add_test(tc, is_equal_29);
  tcase_add_test(tc, is_equal_30);
  tcase_add_test(tc, is_equal_31);
  tcase_add_test(tc, is_equal_32);
